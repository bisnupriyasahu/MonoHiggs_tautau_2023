...
def add_lumi(year, channel_, isBlinded=False, blindingRatio=1):
  lowX=0.40
  lowY=0.80
  lumi  = ROOT.TPaveText(lowX, lowY+0.06, lowX+0.50, lowY+0.14, "NDC")
  ...
  if channel_=="tautau inc":
    lumi.AddText("#tau#tau inclusive"+year+" , "+str(lumiProcessed)+" fb^{-1} (13 TeV)")
  return lumi
...
c=ROOT.TCanvas("canvas","",0,0,2600,2400)
...
padfull = ROOT.TPad("padfull","padfull",0,0,1,1)
padfull.SetFillColor(0)
padfull.SetBorderMode(0)
padfull.SetBorderSize(1)
#padfull.SetTickx(1)
#padfull.SetTicky(1)
padfull.SetLeftMargin(0.15) #0.15
padfull.SetRightMargin(0.15) #0.1
padfull.SetTopMargin(0.122)
padfull.SetBottomMargin(0.025)
padfull.SetFrameFillStyle(0)
padfull.SetFrameLineStyle(0)
padfull.SetFrameLineWidth(1)
padfull.SetFrameBorderMode(0)
padfull.SetFrameBorderSize(1)
