...
var_mapping = { 1: "elePt" ,     2:"eleEta",          3:"elePhi" ,
                ...
                50: "muMetTMassFull", 51 : "mT_muMet", 52 : "mT_eleMet",
                55: 'tot_TMass_new', 60: "cutflow_n", 61: "cutflow_n_fr"
                }
...
def main(hist, ch, isblinded):
    ...
    bashCommandsA =  [ 
                    ...
                    "python3 postAnalyzer.py --hist {} --blinded {}".format(hist, isblinded),
                     ]
    bashCommandsB =  [      
...
if __name__=="__main__":
    ...
    for hist in args.hist.split(','):
        ...
        main(int(hist), channel, args.blinded) # for cutflo_n
