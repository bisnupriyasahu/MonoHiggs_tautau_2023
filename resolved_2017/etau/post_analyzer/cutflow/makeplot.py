...
if piAxis == 1:
  ...
  h1.GetXaxis().SetBinLabel(13,"MET>105");
  h1.GetXaxis().SetBinLabel(12,"MViss<125");
  h1.GetXaxis().SetBinLabel(11,"HiggsPt>65 ");  
  h1.GetXaxis().SetBinLabel(10,"dR mu-tau>0.5");
  h1.GetXaxis().SetBinLabel(9,"b-Jetveto");
  h1.GetXaxis().SetBinLabel(8,"SF & 3rdleptonveto");
  h1.GetXaxis().SetBinLabel(7,"opposite \n ch.");
  h1.GetXaxis().SetBinLabel(6,"passed triggerpT");
  h1.GetXaxis().SetBinLabel(5,"good e-taupairs");
  h1.GetXaxis().SetBinLabel(4,"good taus");
  h1.GetXaxis().SetBinLabel(3,"good Electrons");
