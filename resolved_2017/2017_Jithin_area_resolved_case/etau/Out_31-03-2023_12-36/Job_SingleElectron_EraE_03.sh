...
./analyze_etau root://cmsxrootd.hep.wisc.edu//store/user/jmadhusu/2017_skimmed/etau/SingleElectron_EraE_03.root fullLumi_SingleElectron_EraE_03.root -1 1000 2017 DATA SingleElectron_EraE_03
