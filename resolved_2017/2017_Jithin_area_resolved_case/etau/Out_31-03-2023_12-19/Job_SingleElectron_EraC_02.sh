...
./analyze_etau root://cmsxrootd.hep.wisc.edu//store/user/jmadhusu/blinded_data/2017/etau/SingleElectron_EraC_02.root SingleElectron_EraC_02.root -1 1000 2017 DATA SingleElectron_EraC_02
