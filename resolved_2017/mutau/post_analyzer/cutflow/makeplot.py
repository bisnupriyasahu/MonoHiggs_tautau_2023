...
if piAxis == 1:
  ...
  h1.GetXaxis().SetBinLabel(14,"MET>105");
  h1.GetXaxis().SetBinLabel(13,"MViss<125");
  h1.GetXaxis().SetBinLabel(12,"HiggsPt>65 ");  
  h1.GetXaxis().SetBinLabel(11,"dR mu-tau>0.5");
  h1.GetXaxis().SetBinLabel(10,"b-Jetveto");
  h1.GetXaxis().SetBinLabel(9,"SF & 3rdleptonveto");
  h1.GetXaxis().SetBinLabel(8,"opposite \n ch.");
  h1.GetXaxis().SetBinLabel(7,"boolean 3rdlepveto");
  h1.GetXaxis().SetBinLabel(6,"passed triggerpT");
  h1.GetXaxis().SetBinLabel(5,"good mu-taupairs");
  h1.GetXaxis().SetBinLabel(4,"good taus");
  h1.GetXaxis().SetBinLabel(3,"good Muons");
