...
TLorentzVector tautau_analyzer::MetRecoilCorrections(int tau1Index, int tau2Index, TLorentzVector mymet, int njets){
  ...
  for(int i=0; i<nMC; i++)
      ...
      if(mcPID->at(i)==23)
	{
	  ...
	  //std::cout<<"in recoil the at i =  "<<i<<"  the gen daughters is :  "<<mcDaughterPID->at(i)<<std::endl;
	}
    }
  //visGenP4=BosonP4;
  /* if(BosonP4.Pt()==0)
    {
      for(int i=0; i<nMC; i++)
	{
	  //std::cout<<"in recoil the at i =  "<<i<<"  the gen particle is :  "<<mcPID->at(i)<<std::endl;
	  if(mcPID->at(i)==15)
  ...
  if(BosonP4.Pt()==0)                                                                                                                                                               
    {                                                                                                                                                                                
      for(int i=0; i<nMC; i++)                                                                                                                                                        
        { 	 
	  if(abs(mcPID->at(i))==15 && mcMotherPID->at(i) == 23)
	    std::cout<<"in recoil the at i =  "<<i<<"  the gen particle at i :  "<<mcPID->at(i)<<"   & mother is :  "<<mcMotherPID->at(i)<<std::endl; 
  ...
  for(int i=0; i<nMC; i++)
    {
      ...
      //std::cout<<"in recoil the at i =  "<<i<<"  the gen particle at i :  "<<mcPID->at(i)<<"   & mother is :  "<<mcMotherPID->at(i)<<std::endl; 
      if((abs(mcPID->at(i))==12 || abs(mcPID->at(i))==14 || abs(mcPID->at(i))==12  ) && abs(mcMotherPID->at(i))==23)
	{
	  //std::cout<<"############   for visible  i =  "<<i<<"  the gen particle at i :  "<<mcPID->at(i)<<"   & mother at i is:  "<<mcMotherPID->at(i)<<std::endl;
	  nuP4tmp.SetPtEtaPhiE(mcPt->at(i), mcEta->at(i) , mcPhi->at(i) , mcE->at(i) );
	  visGenP4=visGenP4-nuP4tmp;
	}
    }
