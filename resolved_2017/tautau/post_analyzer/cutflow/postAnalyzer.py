...
def make_files(sampleName = "", hist_name="", isBlinded=False):
    inFile= ROOT.TFile("../files_initial/"+sampleName,"r")
...
def postAnalyzer(hist, isBlinded):
    path = "../files_initial/"
    ...
    for infile in f_list:
        ...
        make_files(infile , var_mapping[int(hist)], isBlinded)
        print('Done......................')
...
if __name__=="__main__":
    ...
    if args.blinded=='1' :
        isBlinded = True
    print(hist,  isBlinded)
    postAnalyzer(hist, isBlinded)
