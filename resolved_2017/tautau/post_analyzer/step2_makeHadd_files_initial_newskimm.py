...
filelist=os.listdir("../output_newskim")
samplelist=[]
...
outFile = open("hadd_files_newskimm.sh", "w")
outFile.write(
"""
#!/bin/bash
set -e 
...
print("""
output written to hadd_files_newskimm.sh 
do  ' bash hadd_files_newskimm.sh '
"""
)
outFile.close()
