...
for line in inputFile:
    line =replaceAll(line, "/hdfs/store/","./MakeCondorFiles.csh analyze_tautau_skim root://cmsxrootd.hep.wisc.edu//store/")
...
os.popen('ls -d /hdfs/store/user/jmadhusu/data2017_31Mar2018_27Aug2022/Tau/*/*/* > data_dir_list')
