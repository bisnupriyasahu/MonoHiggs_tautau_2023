...
Transfer_Input_Files = ${currentDir}/signal_samples_${1}.txt , ${currentDir}/analyze_signal
...
Queue hdfs_path,sample,file_name,isData,parameter from signal_samples_${1}.txt
