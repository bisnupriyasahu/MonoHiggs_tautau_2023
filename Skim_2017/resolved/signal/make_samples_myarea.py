...
inputFile='/hdfs/store/user/bsahu/MonoHToTauTau_ZpBaryonic_TuneCP2_13TeV_2018_v2-run_102X_mc2018_MonoHToTauTau_ZpBaryonic_2018'
...
save_name = 'Signal_ZpBaryonic_2018'
...
#f_submit.write('mkdir -p /hdfs/store/user/bsahu/Resolved_ZPB_signal_sample_17032023/2017_skimmed/signal/'+save_name+'/ \n')
f_submit.write('mkdir -p /hdfs/store/user/bsahu/Resolved_ZPB_signal_sample_17032023/2018_skimmed_in2017skimmer/signal/'+save_name+'/ \n')
#idx = [ '23', '10', '26','32','36', '2', '7', '39', '16']

#idx = ['7', '16', '39']

#for isp in range(1,44):
for isp in range(7,9):
