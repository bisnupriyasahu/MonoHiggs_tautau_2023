  ...
  bool debug=false;  double netWeight = 1.0;
   ...
   for (Long64_t jentry=0; jentry<nentriesToCheck;jentry++)
	 ...
	 continue;
       ...
       //std::cout<<"end:   "<<signalParameters->end()<<std::endl;
      
       //std::cout<<"signalParameters->begin(), signalParameters->end() :  "<<find<<std::endl;

       //       std::cout<<"zprimeBaryonic_signal:   "<<zprimeBaryonic_signal<<std::endl;

     //       plotFill("nEvents_ZpB", 5, 50, 0, 50,  1.0);
       	   // nZpB++;
       //}
