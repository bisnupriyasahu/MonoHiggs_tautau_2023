...
void plotFill(string name, float x, int nx, float nxmin, float nxmax, double weight=1) {
    ...
    //std::cout<<"mymap name "<<(*myMap1)[name]->GetName()<<std::endl;
    //std::cout<<"x is "<<x<<std::endl;
    //std::cout<<" weight is "<<weight<<std::endl;
    //std::cout<<"nZpB bincontent at x "<<x <<" is : "<<(*myMap1)[name]->GetBinContent(x)<<std::endl;
    //std::cout<<"nZpB bincontent x+1 "<<x+1<<" is : "<<(*myMap1)[name]->GetBinContent(x+1)<<std::endl;
