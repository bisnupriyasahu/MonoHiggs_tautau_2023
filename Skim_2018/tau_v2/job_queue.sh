...
./${1} /hdfs/${2}/ ${3}.root -1 1000 2018 ${5}
# for MC samples
#xrdcp ${3}.root /hdfs/store/user/bsahu/Resolved_MC_Skimm/2018_skimmed/tautau/ 
xrdcp ${3}.root /hdfs/store/user/bsahu/Resolved_MC_Skimm_v2_2018/ 


# for blinded data
#xrdcp ${3}.root /hdfs/store/user/bsahu/Resolved_MC_Skimm/2018_skimmed/tautau/blinded/ 
#xrdcp ${3}.root /hdfs/store/user/bsahu/Resolved_MC_Skimm_v2_2018


# for unblinded data # make sure in skimm.C file the jentr %5 !=0 should be in comment 
#xrdcp ${3}.root /hdfs/store/user/bsahu/Resolved_MC_Skimm/2018_skimmed/tautau/unblinded/ 
