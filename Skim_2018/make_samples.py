...
for line in inputFile:
    ...
    fout.close()
    f_submit.write('mkdir -p /hdfs/store/user/bsahu/with_boostedtau/2018_skimmed/with_boostedtaus/etau/'+save_name+'/ \n')
    f_submit.write('./make_condor.sh '+save_name+' \n')
    f_check_nfiles.write('echo '+save_name+' \n ')
    f_check_nfiles.write('ls '+ line +' | wc -l \n')
    f_check_nfiles.write('ls '+'/hdfs/store/user/bsahu/with_boostedtau/2018_skimmed/with_boostedtaus/etau/'+save_name +' | wc -l \n')
