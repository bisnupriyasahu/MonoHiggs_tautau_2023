...
#mv ${4}.root /hdfs/store/user/jmadhusu/with_boostedtau/2018_skimmed/with_boostedtaus/mutau/blinded_${3}/
mv ${4}.root /hdfs/store/user/bsahu/with_boostedtau/2018_skimmed/with_boostedtaus/etau/${3}/
