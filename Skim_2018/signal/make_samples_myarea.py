...
inputFile='/hdfs/store/user/bsahu/MonoHToTauTau_ZpBaryonic_TuneCP2_13TeV_2018_nopfwtag_v0-run_102X_mc2018_MonoHToTauTau_ZpBaryonic_2018/'
...
f_submit.write('mkdir -p /hdfs/store/user/bsahu/Resolved_ZPB_signal_sample_17032023/2018_skimmed/signal/'+save_name+'/ \n')
