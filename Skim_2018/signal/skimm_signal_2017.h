...
// Declaration of leaf types
   ...
   skimm_signal_2017(const char* file1, const char* file2, string isMC, string sampleName, const char* signalpara);
...
skimm_signal_2017::skimm_signal_2017(const char* file1, const char* file2, string isMC, string sampleName, const char* signal_para)

{
  ...
  std::cout<<"file name :::::"<<file1<<std::endl;
  ...
  if(found_ZprimeBaryonic){
    cout<<"__________found_ZprimeBaryonic________"<<endl;
        zprimeBaryonic_signal = atof(signal_para); 
  }
  //cout<<"size of param:  "<<signalParameters->size()<<endl;

  cout<<__LINE__<<" zprimeBaryonic_signal = "<<zprimeBaryonic_signal<<endl;
...
void skimm_signal_2017::Init(TChain *tree, string _isMC_, string sampleName)
{
  ...
  if(isMC=="MC")
    ...
    is_MC=false;
   // Set object pointer
  cout<<"from Init signal = "<<sampleName<<endl;
   // Set object pointer
