...
./${1} /hdfs${2}/${4}.root ${4}.root -1 1000 2018 ${5} ${4}


mv  ${4}.root /hdfs/store/user/bsahu/with_boostedtau/2018_skimmed/with_boostedtaus/etau/blinded_${3}/
# xrdcp ${4}.root root://cmsxrootd.hep.wisc.edu:1094//store/user/jmadhusu/with_boostedtau/2018_skimmed/with_boostedtaus/etau/${3}/
# rm ${4}.root 
