...
if piAxis == 1:
  ...
  h1.GetXaxis().SetBinLabel(13,"HEM veto");
  h1.GetXaxis().SetBinLabel(12,"METcut");
  h1.GetXaxis().SetBinLabel(11,"VisibleMass");
  h1.GetXaxis().SetBinLabel(10,"HiggsPt");
  h1.GetXaxis().SetBinLabel(9,"DeltaR > 0.5");
  h1.GetXaxis().SetBinLabel(8,"NO BjetVeto");
  h1.GetXaxis().SetBinLabel(7,"NO ThirdLepVeto");
  h1.GetXaxis().SetBinLabel(6,"After SFs");
  h1.GetXaxis().SetBinLabel(5,"opp. charge");
  h1.GetXaxis().SetBinLabel(4,"Trigger Pt cuts");
  h1.GetXaxis().SetBinLabel(3,"reco tau pairs");
  ...
  h1.GetXaxis().SetBinLabel(13,"HEM veto");
  h1.GetXaxis().SetBinLabel(12,"MET>105");
  h1.GetXaxis().SetBinLabel(11,"MViss<125");
  h1.GetXaxis().SetBinLabel(10,"HiggsPt>65 ");
  h1.GetXaxis().SetBinLabel(9,"dR tau-tau>0.5");
  h1.GetXaxis().SetBinLabel(8,"NO b-Jetveto");
  h1.GetXaxis().SetBinLabel(7,"NO 3rdleptonveto");
  h1.GetXaxis().SetBinLabel(6,"AFter SFs");
  h1.GetXaxis().SetBinLabel(5,"opposite \n ch.");
  h1.GetXaxis().SetBinLabel(4,"passed trigger pT");
  h1.GetXaxis().SetBinLabel(3,"reco tau pairs");
