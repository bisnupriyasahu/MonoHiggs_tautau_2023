...
#inFile=$1
declare -a plotList=("muPt" "muEta" "muPhi" "muDz" "muD0" "muonID" "relMuIso" "muCharge" "tauPt" "tauEta" "tauPhi" "tauIso" "tauDecayMode" "tauCharge" "tauAntiEle" "tauAntiMu" "deltaR" "higgsPt" "nJet" "visMass" "mT_muMet" "trigger" "genMatch" "met" "metPhi" "deltaPhi" "deltaEta" "metLongXaxis" "metPhiCorr" "higgsPtshort" "tot_TMass") 
...
do
    ...
    do
        hist=$j$i
        python makeplot.py -in $inFile -name $hist -cat 0 -ch mutau -xaxis $hist -year 2018 --blindingRatio 5 &
...
wait
python makeplot.py -in $inFile -name cutflow_n -cat 0 -ch mutau -xaxis "cutflow" -lY  -year 2018 --blindingRatio 5
