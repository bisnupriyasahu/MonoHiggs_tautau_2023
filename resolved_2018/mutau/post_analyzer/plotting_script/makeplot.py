...
#   Data_hist.GetXaxis().SetRangeUser(0, 125.0) 
#   Wjets_hist.GetXaxis().SetRangeUser(0, 125.0) 
#   jetFakes_hist.GetXaxis().SetRangeUser(0, 125.0) 
#   ZTT_hist.GetXaxis().SetRangeUser(0, 125.0) 
#   TT_hist.GetXaxis().SetRangeUser(0, 125.0) 
#   ST_t_hist.GetXaxis().SetRangeUser(0, 125.0) 
#   VV_hist.GetXaxis().SetRangeUser(0, 125.0) 
#   otherMC_hist.GetXaxis().SetRangeUser(0, 125.0) 
# if 'visMass' in histoname:

#   Data_hist.GetXaxis().SetRangeUser(40, 125.0) 
#   Wjets_hist.GetXaxis().SetRangeUser(40, 125.0) 
#   jetFakes_hist.GetXaxis().SetRangeUser(40, 125.0) 
#   ZTT_hist.GetXaxis().SetRangeUser(40, 125.0) 
#   TT_hist.GetXaxis().SetRangeUser(40, 125.0) 
#   ST_t_hist.GetXaxis().SetRangeUser(40, 125.0) 
#   VV_hist.GetXaxis().SetRangeUser(40, 125.0) 
#   otherMC_hist.GetXaxis().SetRangeUser(40, 125.0) 
...
if 'muPt' in histoname or 'elePt' in histoname or 'higgsPt' in histoname or 'tauPt' in histoname or 'tau1Pt' in histoname or 'tau2Pt' in histoname:
  Data_hist.Rebin(2)
  #Wjets_hist.Rebin(2)
  jetFakes_hist.Rebin(2)
  ZTT_hist.Rebin(2)
  TT_hist.Rebin(2)
  ST_t_hist.Rebin(2)
  VV_hist.Rebin(2)
  otherMC_hist.Rebin(2)


if 'higgsPt' in histoname:
  Data_hist.GetXaxis().SetRangeUser(0,200.0)
  Wjets_hist.GetXaxis().SetRangeUser(0,200.0)
  jetFakes_hist.GetXaxis().SetRangeUser(0,200.0)
  ZTT_hist.GetXaxis().SetRangeUser(0,200.0)
  TT_hist.GetXaxis().SetRangeUser(0,200.0)
  ST_t_hist.GetXaxis().SetRangeUser(0,200.0)
  VV_hist.GetXaxis().SetRangeUser(0,200.0)
  otherMC_hist.GetXaxis().SetRangeUser(0,200.0)
...
#     final_err = prev_err
#   if final_err > 0.2 * content:
#     final_err = 0.2* content
#   prev_err = final_err
