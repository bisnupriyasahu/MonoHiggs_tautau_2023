...
public:
  ...
  float get_ff(float pt, float mt, float mvis, float msv, float lpt, float met, int njets, bool xtrg, float frac_tt, float frac_qcd, float frac_w, TString shift){
    ...
    // if (ff_qcd==0 || ff_w==0 || ff_tt==0)
    //   cout<<__LINE__<<"    f: "<<ff_qcd<<"  "<<ff_w<<"  "<<ff_tt<<"         one is zero!"<<endl;
    // L pT closure
    if (xtrg){
      if (pt<40){
    ...
    // if (ff_qcd==0 || ff_w==0 || ff_tt==0)
    //   cout<<__LINE__<<"    f: "<<ff_qcd<<"  "<<ff_w<<"  "<<ff_tt<<"      !!! lpt="<<lpt<<"   xtrg="<<xtrg<<endl;
    ...
    // if(ff_cmb==0)
    //   cout<<__LINE__<<"    f: "<<ff_qcd<<"  "<<ff_w<<"  "<<ff_tt<<"         !!!!!!"<<endl;
    return ff_cmb;
  } 
