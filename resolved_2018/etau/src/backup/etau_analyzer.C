			      ...
			      if (  eleCharge->at(EleIndex) * tau_Charge->at(TauIndex) < 0 ) 
				{
				  ...
				  if ( MatchTriggerFilter(EleIndex, TauIndex) )
					...
					applySf=  getScaleFactors( my_eleP4.Pt(),
				      ...
				      event_weight = event_weight * applySf;
				      //if ( isnan(event_weight)  )
				      //cout<<__LINE__<<"  checking for nan "<<event_weight<<endl;
...
void etau_analyzer::fillHist( string histNumber , int eleIndex, int tauIndex, bool isFakeBkg, float event_weight){
  ...
  // if(isnan(event_weight)){
  //   cout<<"event_weight is "<< event_weight<< "       NAN "<<__LINE__<<endl;
  // }
  //plotFill("elePt_"+hNumber,  my_eleP4.Pt() , 76 , 24 , 100,  event_weight);  /// smhtt binning
  ...
  //plotFill("tauPt_"+hNumber,  my_tauP4.Pt() , 25 , 30 , 80,  event_weight); /// smhtt binning
  ...
  //plotFill("visMass_"+hNumber, visMass_mutau , 30, 50, 200,  event_weight); /// smhtt binning
  ...
  //plotFill("higgsPt_"+hNumber,HiggsPt , 25, 0, 250,  event_weight); /// smhtt binning
...
void etau_analyzer::fillUncPlots( string histNumber , int eleIndex, int tauIndex, bool isFakeBkg, float event_weight){
  ...
  // fillHist(histNumber+"_tauh_Prefiring_up", EleIndex, TauIndex, true, event_weight*prefiringweightup/prefiringweight);
  // fillHist(histNumber+"_tauh_Prefiring_down", EleIndex, TauIndex, true, event_weight*prefiringweightdown/prefiringweight);
...
void etau_analyzer::jetFakeUnc( string histNumber , int eleIndex, int tauIndex, bool isFakeBkg, float event_weight){
  // if(isnan(event_weight)){
  //   cout<<"event_weight is NAN "<<__LINE__<<endl;
  // }
  ...
  for(int u = 0; u < 2; u++) {
    for(int i = 0; i < 15; i++) {
      ...
      double FF_unc = FF_weights_withlpt.get_ff( my_tauP4.Pt(), mt, mvis
						 ...
						 , frac_tt, frac_qcd, frac_w
						 ,TString(uncName));
      //cout<< uncName  << " FF_unc = "<< FF_unc <<endl;
...
void etau_analyzer::tauESunc( string histNumber , int eleIndex, int tauIndex, bool isFakeBkg, float event_weight){
  ...
  string histName = "CMS_scale_t_"+dmName+"_2018";
...
void etau_analyzer::electronMissID( string histNumber , int eleIndex, int tauIndex, bool isFakeBkg, float event_weight){
  ...
  string histName = histNumber + "_CMS_scale_efaket_" + taudm + "_" + region +"_2018";
...
void etau_analyzer::muonES( string histNumber , int eleIndex, int tauIndex, bool isFakeBkg, float event_weight){
  ...
  string histName = histNumber + "_CMS_scale_m_" +region +"_2018";
...
void etau_analyzer::muonMissID( string histNumber , int eleIndex, int tauIndex, bool isFakeBkg, float event_weight){
  ...
  string histName = histNumber + "_CMS_scale_mfaket_" + taudm + "_" +region +"_2018";
...
void etau_analyzer::tauIDunc( string histNumber , int eleIndex, int tauIndex, bool isFakeBkg, float event_weight){
  ...
  if (my_tauP4.Pt() >= 30 && my_tauP4.Pt()<35)
    uncName = "CMS_tauideff_pt30to35_2018";
  else if (my_tauP4.Pt() >= 35 && my_tauP4.Pt()<40)
    uncName = "CMS_tauideff_pt35to40_2018";
  else if (my_tauP4.Pt() >= 40 )
    uncName = "CMS_tauideff_ptgt40_2018";
