...
class MEtSys {
 ...
 public:
  MEtSys(){
    ...
    TString fileName = "sf_files/HTT-utilities/RecoilCorrections/data/PFMEtSys_2018.root";
    TString _fileName = "sf_files/HTT-utilities/RecoilCorrections/data/PFMEtSys_2018.root";
