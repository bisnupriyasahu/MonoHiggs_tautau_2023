...
./${1} root://cmsxrootd.hep.wisc.edu:1094//store/user/jmadhusu/with_boostedtau/2018_skimmed/with_boostedtaus/signal_v2/${2}.root ${2}.root -1 1000 2018 ${3} ${2}
#./${1} root://cmsxrootd.hep.wisc.edu:1094//store/user/jmadhusu/with_boostedtau/2017_skimmed/with_boostedtaus/signal/${2}.root ${2}.root -1 1000 2018 ${3} ${2}
