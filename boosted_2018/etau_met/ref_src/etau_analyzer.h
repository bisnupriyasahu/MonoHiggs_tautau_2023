...
public:
  ...
  double nMETFiltersPassed_fr, nPassedSkimmed_fr, nSingleTrgPassed_fr, nGoodElectronPassed_fr, nGoodTauPassed_fr, nGoodEleTauPassed_fr, nPassedThirdLepVeto_fr, nPassedBjetVeto_fr, nDeltaRPassed_fr;
  double nMETFiltersPassed, nPassedSkimmed, nSingleTrgPassed, nGoodElectronPassed, nGoodTauPassed, nGoodEleTauPassed, nPassedThirdLepVeto, nPassedBjetVeto, nDeltaRPassed;

  double nMETFiltersPassed_dyll_fr, nPassedSkimmed_dyll_fr, nSingleTrgPassed_dyll_fr, nGoodElectronPassed_dyll_fr, nGoodTauPassed_dyll_fr, nGoodEleTauPassed_dyll_fr, nPassedThirdLepVeto_dyll_fr, nPassedBjetVeto_dyll_fr, nDeltaRPassed_dyll_fr;
  double nMETFiltersPassed_dyll, nPassedSkimmed_dyll, nSingleTrgPassed_dyll, nGoodElectronPassed_dyll, nGoodTauPassed_dyll, nGoodEleTauPassed_dyll, nPassedThirdLepVeto_dyll, nPassedBjetVeto_dyll, nDeltaRPassed_dyll;
...
TFile *f_pileup = new TFile("sf_files/2017/RootFiles/pileup/PU_Central.root");
 ...
 TFile *f_HiggsPtReweighting = TFile::Open("sf_files/NNLOPS_reweight.root");
  ...
  TFile * f_mettrg = TFile::Open("sf_files/trg_eff_met120_mht120.root"); 
  TH2F *h_mettrg_sf = (TH2F*)f_mettrg->Get("met_mhtScalar_ratio");
  ...
  etau_analyzer(const char *file1, const char *file2, string isMC, string SampleName, const char *signal_para);
  ...
  virtual vector<int> simple_ele_cand(double pt, double eta, int shift);
  ...
  virtual vector<int> getEleCand(double pt, double eta, int shift);
  ...
  // double dR(int ele_index, int tau_index);
  ...
  void fillHist(string histNumber, int eleIndex, int tauIndex, bool isFakeBkg, float event_weight);
  ...
  void get_index(vector<int> ele_indices, vector<int> tau_indices, vector<int> boostedtau_indices, int &ele_index, int &tau_index, bool &isBoosted);
  void get_index_jettau(vector<int> ele_indices, vector<int> tau_indices, vector<int> boostedtau_indices, int &ele_index, int &tau_index, bool &isBoosted);
};

#endif

#ifdef etau_analyzer_cxx
etau_analyzer::etau_analyzer(const char *file1, const char *file2, string isMC, string sampleName, const char *signal_para)
{
...
void etau_analyzer::Init(TChain *tree, string _isMC_, string sampleName)
{
  ...
  nMETFiltersPassed_fr = nPassedSkimmed_fr = nSingleTrgPassed_fr = nGoodElectronPassed_fr = nGoodTauPassed_fr = nGoodEleTauPassed_fr = nPassedThirdLepVeto_fr = nPassedBjetVeto_fr = nDeltaRPassed_fr = 0;
  nMETFiltersPassed = nPassedSkimmed = nSingleTrgPassed = nGoodElectronPassed = nGoodTauPassed = nGoodEleTauPassed = nPassedThirdLepVeto = nPassedBjetVeto = nDeltaRPassed = 0;

  nMETFiltersPassed_dyll_fr = nPassedSkimmed_dyll_fr = nSingleTrgPassed_dyll_fr = nGoodElectronPassed_dyll_fr = nGoodTauPassed_dyll_fr = nGoodEleTauPassed_dyll_fr = nPassedThirdLepVeto_dyll_fr = nPassedBjetVeto_dyll_fr = nDeltaRPassed_dyll_fr = 0;
  nMETFiltersPassed_dyll = nPassedSkimmed_dyll = nSingleTrgPassed_dyll = nGoodElectronPassed_dyll = nGoodTauPassed_dyll = nGoodEleTauPassed_dyll = nPassedThirdLepVeto_dyll = nPassedBjetVeto_dyll = nDeltaRPassed_dyll = 0;
...
void etau_analyzer::setMyEleTau(int eleIndex, int tauIndex, TLorentzVector event_metP4, int shift, bool isBoostedtau)
{
  ...
  my_eleP4.SetPtEtaPhiE(elePt->at(eleIndex), eleEta->at(eleIndex),
    ...
    if(is_MC){ 
     ...
     corrected_met_v2 = MetRecoilCorrections(eleIndex, tauIndex, my_metP4); 
    ...
    deltaR    = my_eleP4.DeltaR(my_tauP4);
    deltaPhi  = my_eleP4.DeltaPhi(my_tauP4);
    deltaEta  = abs(my_eleP4.Phi() - my_tauP4.Phi());
    mT_eleMet  = TMass_F( my_eleP4.Pt(),my_eleP4.Phi(), my_metP4.Pt(), my_metP4.Phi() );
    visMass_eletau = (my_eleP4+ my_tauP4).M();
    HiggsPt   = (my_eleP4 + my_tauP4).Pt();
    delpta_phi_HptMet = (my_eleP4+my_tauP4).DeltaPhi(my_metP4);
    tot_tr_mass  =  (my_eleP4 + my_tauP4 + my_metP4 ).M();
