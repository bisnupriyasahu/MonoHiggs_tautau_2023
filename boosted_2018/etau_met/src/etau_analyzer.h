...
public :
  ...
  virtual void BookHistos(const char* file1, const char* file2, string year);
...
void etau_analyzer::setMyEleTau(int eleIndex, int tauIndex, TLorentzVector metP4, int shift, bool isBoostedtau){
...
EleIndex = eleIndex;
  ...
  my_eleP4.SetPtEtaPhiE(elePt->at(eleIndex), eleEta->at(eleIndex),
    ...
    TLorentzVector corrected_met_v1;
    corrected_met_v1 = my_metP4 + my_tauP4 - (0.97)*my_tauP4;

    if(is_MC)
      my_tauP4 = 0.97*my_tauP4;
    
    if(is_MC){ 
     TLorentzVector corrected_met_v2; 
     //corrected_met_v2.SetPtEtaPhiE(pfMET ,0,pfMETPhi,pfMET); 
     corrected_met_v2 = MetRecoilCorrections(eleIndex, tauIndex, corrected_met_v1); 
