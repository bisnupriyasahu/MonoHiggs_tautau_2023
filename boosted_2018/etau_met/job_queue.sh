...
./${1} root://cmsxrootd.hep.wisc.edu:1094//store/user/jmadhusu/with_boostedtau/2018_skimmed/with_boostedtaus/etau_hadd/${2}.root ${2}.root -1 1000 2018 ${3} ${2}
# ./${1} /hdfs/store/user/jmadhusu/with_boostedtau/2018_skimmed/with_boostedtaus/etau_hadd/${2}.root ${2}.root -1 1000 2018 ${3} ${2}
