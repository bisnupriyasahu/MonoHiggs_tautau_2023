...
my_dict = {}
path2 = '/hdfs/store/user/jmadhusu/with_boostedtau/2018_skimmed/with_boostedtaus/mutau_hadd/'
...
for k , v in my_dict.items():
    ...
    fout.write('mv '+k+'.root /hdfs/store/user/jmadhusu/with_boostedtau/2018_skimmed/with_boostedtaus/mutau_hadd/ \n')
...
for k, v in my_dict.items():
    ...
    f_submit.write('du -sh /hdfs/store/user/jmadhusu/with_boostedtau/2018_skimmed/with_boostedtaus/mutau_hadd/'+k+'.root \n')
