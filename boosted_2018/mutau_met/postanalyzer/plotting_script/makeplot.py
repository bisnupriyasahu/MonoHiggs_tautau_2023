...
print(dirname[0]+"Signal_MZp_100_MChi_1_"+histoname)
...
# if 'visMass' in histoname:
#   Data_hist.GetXaxis().SetRangeUser(50, 125.0) 
#   Wjets_hist.GetXaxis().SetRangeUser(50, 125.0) 
#   jetFakes_hist.GetXaxis().SetRangeUser(50, 125.0) 
#   ZTT_hist.GetXaxis().SetRangeUser(50, 125.0) 
#   TT_hist.GetXaxis().SetRangeUser(50, 125.0) 
#   ST_t_hist.GetXaxis().SetRangeUser(50, 125.0) 
#   VV_hist.GetXaxis().SetRangeUser(50, 125.0) 
#   otherMC_hist.GetXaxis().SetRangeUser(50, 125.0) 
'''
if 'muPt' in histoname or 'elePt' in histoname or 'tauPt' in histoname or  'higgsPt' in histoname :
  bin_group =2 
  if 'tauPt' in histoname or 'muPt' in histoname :
    bin_group = 5
