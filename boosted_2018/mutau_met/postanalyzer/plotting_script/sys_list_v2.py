...
shape_list = {
    ...
    'CMS_htt_boson_scale_met_Jet_2018' : ['ZTTjet' ,'ZLLjet'] ,
    'CMS_htt_boson_reso_met_Jet_2018' : ['ZTTjet' ,'ZLLjet'] ,
    'CMS_htt_dyShape' : ['ZTTjet' ,'ZLLjet'] ,
    'CMS_htt_ttbarShape' : ['TTL'] ,
    # #'CMS_Prefiring' : ['ZTTjet' ,'ZLLjet', 'VVL', 'STL', 'TTL' , 'VVT', 'STT', 'TT'] ,
    'CMS_scale_met_unclustered_2018' : ['VVL', 'STL', 'TTL' , 'VVT', 'STT', 'TT', 'otherMC'] ,
