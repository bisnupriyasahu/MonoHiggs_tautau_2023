...
dirname = ["mutau/",histoname, histoname+"_fr/", histoname+"_dyll/", histoname+"_dyll_fr/"]


OutFile=ROOT.TFile('mutau.root',"r")
...
signal_MZp_100_MChi_1 = OutFile.Get(dirname[0]+"Signal_MZp_100_MChi_1")
signal_MZp_1000_MChi_1 = OutFile.Get(dirname[0]+"Signal_MZp_1000_MChi_1")
signal_MZp_1500_MChi_1 = OutFile.Get(dirname[0]+"Signal_MZp_1500_MChi_1")
