...
samples = sorted(os.listdir('/hdfs/store/user/jmadhusu/with_boostedtau/2018_skimmed/with_boostedtaus/tautau_hadd/'))
...
for line in samples:
    ...
    if 'SingleMuon' in line:
        continue
    if 'MET' in line:
      line = "analyze_tautau "+ line + " DATA \n"
    else:
      line = "analyze_tautau "+ line + " MC \n"
