...
histoname="tot_TMass_new"
year_='2017'
category_=args.category
xaxis_label="tot_TMass_new"
channel_='tautau'
blindingRatio_ = int(1)
eventsPerBin=""
...
dirname = ["tautau/",histoname, histoname+"_fr/", histoname+"_dyll/", histoname+"_dyll_fr/"]


OutFile=ROOT.TFile('tautau.root',"r")
...
OutFile.cd()
print(dirname[0]+"data_obs")
Data_hist    =OutFile.Get(dirname[0]+"data_obs")
ZTT_hist     = OutFile.Get(dirname[0]+"ZTTjet")
# Wjets_hist   = OutFile.Get(dirname[0]+"WJets_jets")
TT_hist      = OutFile.Get(dirname[0]+"TT")
ST_t_hist    = OutFile.Get(dirname[0]+"STT")
VV_hist      = OutFile.Get(dirname[0]+"VVT")
otherMC_hist  = OutFile.Get(dirname[0]+"otherMC")
jetFakes_hist = OutFile.Get(dirname[0]+"jetFakes")

signal_MZp_100_MChi_1 = OutFile.Get(dirname[0]+"Signal_2HDMa_gg_sinp_0p35_tanb_1p0_mXd_10_MH3_300_MH4_100")
signal_MZp_1000_MChi_1 = OutFile.Get(dirname[0]+"Signal_2HDMa_gg_sinp_0p35_tanb_1p0_mXd_10_MH3_400_MH4_100")
signal_MZp_1500_MChi_1 = OutFile.Get(dirname[0]+"Signal_2HDMa_gg_sinp_0p35_tanb_1p0_mXd_10_MH3_500_MH4_150")
...
if 'muPt' in histoname or 'elePt' in histoname or 'tauPt' in histoname or  'higgsPt' in histoname :
  bin_group =2 
  if 'tauPt' in histoname :
    bin_group = 5
  Data_hist.Rebin(bin_group)
  # Wjets_hist.Rebin(bin_group)
  jetFakes_hist.Rebin(bin_group)
  ZTT_hist.Rebin(bin_group)
  TT_hist.Rebin(bin_group)
  ST_t_hist.Rebin(bin_group)
  VV_hist.Rebin(bin_group)
  otherMC_hist.Rebin(bin_group)
...
print("Bin content for bin 5")
print("ZTT" , round(ZTT_hist.GetBinContent(5), 4))
print("TT"  ,round(TT_hist.GetBinContent(5), 4))
print("jetTau" ,round(jetFakes_hist.GetBinContent(5), 4))
print("SingleTop", round(ST_t_hist.GetBinContent(5), 4))
print("Diboson", round(VV_hist.GetBinContent(5), 4))
print("other MC" , round(otherMC_hist.GetBinContent(5), 4))
...
if 'tot_TMass_full' in histoname or 'tot_TMass_new' in histoname:
  ...
  #signal_MZp_1000_MChi_1.Scale(10)
...
print("signal_MZp_1000_MChi_1" ,signal_MZp_1000_MChi_1.Integral())
...
#legende=make_legend()
legende = ROOT.TLegend(0.85, 0.30, 0.999, 0.80, "", "brNDC")
legende.SetLineWidth(1)
legende.SetLineStyle(1)
legende.SetFillStyle(1001) #0
legende.SetFillColor(0)
legende.SetBorderSize(1)
legende.SetTextFont(40)
legende.SetTextSize(0.018)
legende.SetNColumns(1) 
...
if 'tot_TMass_full' in histoname or 'tot_TMass_new' in histoname :
  ...
  signal_MZp_1000_MChi_1.SetLineColor(55)
  legende.AddEntry(signal_MZp_1000_MChi_1, 'MZp=1000 MChi=1 (x10)', "el")
