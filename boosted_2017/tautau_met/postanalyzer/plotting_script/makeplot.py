...
if 'muPt' in histoname or 'elePt' in histoname or 'tauPt' in histoname or  'higgsPt' in histoname or 'tau1Pt' in histoname or 'tau2Pt' in histoname:
  bin_group =2 
  if 'tauPt' in histoname or 'tau1Pt' in histoname or 'tau2Pt' in histoname:
    bin_group = 5
...
if 'tot_TMass_new' in histoname:
  ...
  VV_hist.Rebin(bin_group)
  otherMC_hist.Rebin(bin_group)
  signal_MZp_100_MChi_1.Rebin(bin_group)
  signal_MZp_1000_MChi_1.Rebin(bin_group)
  signal_MZp_1500_MChi_1.Rebin(bin_group)
...
for ibin in range(numberOfBins+1):
  print('jetfakes', ibin, jetFakes_hist.GetBinContent(ibin))
