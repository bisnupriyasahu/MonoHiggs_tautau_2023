...
path = '/hdfs/store/user/jmadhusu/with_boostedtau/2017_skimmed/with_boostedtaus/mutau/'
samples = sorted(os.listdir('dataset'))

my_dict = {}
path2 = '/hdfs/store/user/jmadhusu/with_boostedtau/2017_skimmed/with_boostedtaus/hadd/'
...
for k , v in my_dict.items():
    ...
    # fout.write('xrdcp '+k+'.root root://cmsxrootd.hep.wisc.edu:1094//store/user/jmadhusu/with_boostedtau/2017_skimmed/with_boostedtaus/hadd/ \n')
    fout.write('mv '+k+'.root /hdfs/store/user/jmadhusu/with_boostedtau/2017_skimmed/with_boostedtaus/hadd/ \n')
...
for k, v in my_dict.items():
    ...
    f_submit.write('du -sh /hdfs/store/user/jmadhusu/with_boostedtau/2017_skimmed/with_boostedtaus/hadd/'+k+'.root \n')
