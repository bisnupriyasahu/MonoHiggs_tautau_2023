...
if 'muPt' in histoname or 'higgsPt' in histoname :
  Data_hist.Rebin(2)
  Wjets_hist.Rebin(2)
...
if isinstance(signal_MZp_100_MChi_1, ROOT.TH1F) :
...
for ibin in range(1, numberOfBins+1):
  ...
  total_error = sqrt( stat_err*stat_err)
...
c.Modified()
c.SaveAs("plots/plot_"+histoname+"_"+channel_+"_logx.png")
